...
```bash
# 例: Linux amd64（v0.2.3 の場合）
curl -Lo dsx.tar.gz https://github.com/scottlz0310/dsx/releases/download/v0.2.3/dsx_0.2.3_linux_amd64.tar.gz
tar xzf dsx.tar.gz
...
本バージョンは **初の安定版リリース** です。安定化期間中は `setup-repo` との併用を推奨します。
