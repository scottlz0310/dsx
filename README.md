...
```bash
# 例: Linux amd64（v0.2.4 の場合）
curl -Lo dsx.tar.gz https://github.com/scottlz0310/dsx/releases/download/v0.2.4/dsx_0.2.4_linux_amd64.tar.gz
tar xzf dsx.tar.gz
...
本バージョンは **修正と運用改善を中心にした安定版メンテナンスリリース** です。既存の運用導線を保ちながら、`repo` 系の可観測性と安全性を高めています。
