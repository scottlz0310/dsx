...
```bash
# 例: Linux amd64（v0.6.3 の場合）
curl -Lo dsx.tar.gz https://github.com/scottlz0310/dsx/releases/download/v0.6.3/dsx_0.6.3_linux_amd64.tar.gz
tar xzf dsx.tar.gz
